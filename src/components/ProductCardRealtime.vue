        ...
        <div class="col-md-3 col-sm-3 col-xs-3 self-center">
          <div class="text-h9">
            <div class="row">
              ...
              <div class="col-12" style="font-size: 13px">
                {{
                  `${Math.trunc(machine.avgProcessingTime / 1000 / 60)} 分 ${
                    Math.trunc(machine.avgProcessingTime / 1000) % 60
                  } 秒`
                }}
              </div>
...
import { Details } from '../store/socket/state';

export default defineComponent({
  name: 'ProductCardRealtime',
  components: { DoughnutChartInCard },
  props: {
    machines: Object as () => Details[],
  },
  setup() {
    return {};
  },
